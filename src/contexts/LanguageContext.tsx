...
const translations: Record<string, Record<string, string>> = {
  ...
  memories_title: { en: "System Memories", rw: "Ububiko bw'Ibyabaye", fr: "Mémoires Système", sw: "Kumbukumbu za Mfumo", zh: "系统记忆", es: "Memorias del Sistema", pt: "Memórias do Sistema", de: "System-Erinnerungen", ar: "ذاكرة النظام", hi: "सिस्टम मेमोरीज़", ja: "システムメモリ", ko: "시스템 메모리" },
