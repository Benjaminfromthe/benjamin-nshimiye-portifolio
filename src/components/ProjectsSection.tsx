...
const projects = [
  {
    ...
    category: "Transport",
    desc: "A smart transport management platform designed to revolutionize urban mobility. Features include real-time vehicle tracking, route optimization, and digital ticketing.",
  ...
  },
  {
    ...
    category: "Trade",
    desc: "An international trade facilitation platform connecting African manufacturers with global markets. Streamlines import/export documentation and logistics.",
